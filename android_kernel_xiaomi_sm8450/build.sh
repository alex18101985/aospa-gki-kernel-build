...
grep -E "CONFIG_LTO|CONFIG_CC_OPTIMIZE|BTF|DEBUG_INFO|KASAN|CONFIG_LOCKDEP=|DEBUG_FS|SLUB_DEBUG|DYNAMIC_FTRACE|KFENCE|FTRACE|TRACEPOINTS|EVENT_TRACING|FUNCTION_TRACER|STACK_TRACER" out/.config
