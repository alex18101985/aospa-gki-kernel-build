...
grep -E "CONFIG_LTO|CONFIG_CC_OPTIMIZE|BTF|DEBUG_INFO|CONFIG_KASAN=|CONFIG_LOCKDEP=|CONFIG_SLUB_DEBUG|CONFIG_KFENCE|CONFIG_FTRACE=|CONFIG_FUNCTION_TRACER=|CONFIG_STACK_TRACER=" out/.config
