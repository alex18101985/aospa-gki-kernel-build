...
grep -E "CONFIG_LTO|CONFIG_CC_OPTIMIZE|BTF|DEBUG_INFO|KASAN|LOCKDEP|CONFIG_LOCKDEP=|CONFIG_DEBUG_FS=|SLUB_DEBUG|KFENCE|FTRACE|FUNCTION_TRACER|STACK_TRACER" out/.config
